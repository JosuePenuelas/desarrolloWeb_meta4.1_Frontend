      ...
      <v-dialog v-model="showNewDialog" max-width="500px">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-text-field v-model="newImagenUbi" label="Imagen Ubicación"></v-text-field>
          </v-card-text>
          <v-card-actions>
      ...
      <v-dialog v-model="showUpdateDialog" max-width="500px">
        <v-card>
          ...
          <v-card-text>
            ...
            <v-text-field v-model="updateImagenUbi" label="Imagen Ubicación"></v-text-field>
          </v-card-text>
          <v-card-actions>
...
async function cargarDatosUpdate() {
  try {
    ...
    updateImagenUbi.value = data.imagenUbi;
  } catch (error) {
