    ...
    <v-dialog v-model="showNewDialog" max-width="500px">
      <v-card>
        ...
        <v-card-text>
          ...
          <v-file-input v-model="newImagenResponsable" label="Imagen Responsable"></v-file-input>
        </v-card-text>
        <v-card-actions>
    ...
    <v-dialog v-model="showUpdateDialog" max-width="500px">
      <v-card>
        ...
        <v-card-text>
          ...
          <v-file-input v-model="updateImagenResponsable" label="Imagen Responsable"></v-file-input>
        </v-card-text>
        <v-card-actions>
  ...
  try {
    const response = await fetch('https://localhost:4000/responsables', {
      ...
      body: JSON.stringify({
        ...
        imagen: newImagenResponsable.value,
      }),
      headers: {
  ...
  try {
    const response = await fetch(`https://localhost:4000/responsables/${updateId.value}`, {
      ...
      body: JSON.stringify({
        ...
        imagen: updateImagenResponsable.value,
      }),
      headers: {
        'Content-type': 'application/json; charset=UTF-8',
      },
